                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text">{{ ucfirst(auth()->user()->fname) }}</span>
                                <h6 class="d-none d-xl-block ms-1 text-white user-name-sub-text">{{ (auth()->user()->roles[0]->name) ? auth()->user()->roles[0]->name : Auth::user()->fname }}</h6>
                            </span>
                        </span>
                    </button>
