<x-admin.layout>
    <x-slot name="title">Election Attendance Report(उपस्थिती अहवाल)</x-slot>
    <x-slot name="heading">Election Attendance Report(उपस्थिती अहवाल)</x-slot>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Election Attendance Report(उपस्थिती अहवाल)</h4>
                    </div>
                    <div class="card-body">
                        <div class="mb-3 row">
                            <div class="my-2">
                                ...
                                <table id="buttons-datatables" class="dataTable table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $attendanceMeetingReport->electionScheduleMeeting?->electionAgenda?->subject }}</td>
                                            <td>{{ $attendanceMeetingReport->electionMeeting?->name }}</td>
                                            <td>{{ $attendanceMeetingReport->electionScheduleMeeting?->unique_id }}</td>
                                            ...
                                            <td>{{ ($attendanceMeetingReport->electionScheduleMeeting->datetime) ? date('d-m-Y h:i: A', strtotime($attendanceMeetingReport->electionScheduleMeeting->datetime)) : '-' }}</td>
                                            <td>{{ $attendanceMeetingReport->electionScheduleMeeting?->place }}</td>
