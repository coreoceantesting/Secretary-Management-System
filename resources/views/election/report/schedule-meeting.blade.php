<x-admin.layout>
    <x-slot name="title">Election Meeting Report(बैठकीचा अहवाल करा)</x-slot>
    <x-slot name="heading">Election Meeting Report(बैठकीचा अहवाल करा)</x-slot>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Election Meeting Report(बैठकीचा अहवाल करा)</h4>
                    </div>
                    <div class="card-body">
                        <div class="mb-3 row">
                            <div class="my-2">
                                ...
                                <table id="buttons-datatables" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('election.report.viewScheduleMeetingReport', $scheduleMeeting->id) }}" class="btn text-secondary px-1 py-1">
