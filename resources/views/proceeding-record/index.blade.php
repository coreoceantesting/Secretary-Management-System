                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="date" name="date" type="date" placeholder="Enter date" value="{{ date('Y-m-d') }}">
                                <span class="text-danger is-invalid date_err" readonly></span>
                            </div>
                            <div class="col-md-4">
                                <label class="col-form-label" for="time">Time <span class="text-danger">*</span></label>
                                <input class="form-control" id="time" name="time" type="time" placeholder="Enter time" value="{{ date('h:i:s') }}">
                                <span class="text-danger is-invalid time_err" readonly></span>
                            </div>
                            <div class="col-md-4">
