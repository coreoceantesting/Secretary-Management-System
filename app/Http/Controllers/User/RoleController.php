                    ...
                    $permissionsHtml .= '</div>
                                    <div class="form-group m-t-15 row roles-checkbox-group">
                                        ...
                                        <div class="col-3 py-2 form-check">
                                            <label class="d-block form-check-label" for="chk-ani' . $permission->name . $incrementCount . '">
                                                <input class="checkbox_animated form-check-input" id="chk-ani' . $permission->name . $incrementCount . '" type="checkbox"  name="edit_permission[]" value="' . $permission->name . '" ' . $isChecked . '>' . explode('.', $permission->name)[1] . '
                                            </label>
                                        </div>';
                } else {
